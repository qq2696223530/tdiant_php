	...
	<div class="register_area" style="display: none;">
	    <div class="form form_register clearFix">
	        ...
	        <div class="form_input code">
	            ...
	            <img id="register_vcode_image" src="./denglu/index.php">
	        ...
	        <div class="form_input"><a class="btn register" id="register_post_button" href="javascript:void(0);">确认注册</a></div>
	    </div>
	...
	<div class="forget_password_area" style="display: none;">
	    <div class="form form_register clearFix">
	        ...
	        <div class="form_input code">
	            ...
	            <img id="get_password_vcode_image" src="./denglu/index(1).php">
